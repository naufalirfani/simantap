      ...
      >
        {disabled ? (
          ...
          <input
            ...
            className={`w-full px-3 pr-20 py-2.5 border rounded-lg text-sm dark:text-white bg-white dark:bg-gray-600 border-gray-300 dark:border-gray-500 focus:ring-2 focus:ring-teal-500 ${isOpen ? 'cursor-text' : 'cursor-pointer'}`}
            readOnly={!isOpen}
          />
        )}
