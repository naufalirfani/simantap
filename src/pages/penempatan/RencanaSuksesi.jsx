...
const RencanaSuksesi = () => {
  useEffect(() => {
    document.title = "Rencana Suksesi | SIMANTAP";
  }, []);
    ...
    <div className="p-4 md:p-6 lg:p-8">
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-md md:text-base text-gray-600 dark:text-gray-300">
          Perencanaan penempatan talenta pada posisi kunci/suksesi
        </p>
      </div>
      ...
      <div className="flex items-center justify-center h-64 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="text-center text-gray-400 dark:text-gray-500">
          <i className="fas fa-map-signs text-5xl mb-4"></i>
          <p className="text-lg font-medium">Halaman Rencana Suksesi</p>
