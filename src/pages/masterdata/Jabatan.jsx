...
const Jabatan = () => {
  ...
  useEffect(() => {
    document.title = `${t("jabatan")} | SIMANTAP`;
  }, [t]);
  ...
  const loadData = async () => {
    try {
      ...
      const uniqueJabatan = getUniqueJabatan(petaJabatanData);
      setData(uniqueJabatan);
    } catch (err) {
      setError(err.message || t("errorLoadingJabatan"));
  ...
  const columns = [
    ...
    {
      key: "jenis_jabatan",
      label: t("jenisJabatan"),
      sortable: true,
      align: "center",
    },
    {
      key: "kelas_jabatan",
      label: t("kelasJabatan"),
      sortable: true,
      align: "center",
    },
    {
      key: "kebutuhan_pegawai",
      label: t("kebutuhanPegawai"),
      sortable: true,
      align: "center",
    },
    {
    ...
    },
    {
      ...
      render: (item) => {
        ...
        return (
          <span
            className={
              isNegative ? "font-bold text-red-600 dark:text-red-400" : ""
            }
          >
            {selisih}
          </span>
